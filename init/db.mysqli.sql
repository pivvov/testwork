...
<h1>Добро пожаловать в Limb!</h1>
    ...
    <ul>
      <li class="level1"><div class="li"> <a href="http://wiki.limb-project.com/doku.php?id=limb3:ru:tutorials:basic" class="wikilink1" title="limb3:ru:tutorials:basic">базовый пример</a>, где показаны только самые основы использования пакетов WEB_APP, ACTIVE_RECORD и MACRO.</div></li>
    ...
    <ul>
      ...
      <li class="level1"><div class="li"> примеры использования шаблонизатора MACRO</div></li>
...
CREATE TABLE `lmb_cms_category` (
	`id` int(5) not null auto_increment,
	`name` varchar(255) not null,
	primary key pk_category(`id`)
) engine=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `lmb_cms_product` (                    
 `id` INT(11) NOT NULL AUTO_INCREMENT,  
 `title` VARCHAR(255) DEFAULT NULL,        
 `description` text,                       
...
CREATE TABLE `lmb_cms_order_line` (                    
 `id` INT(11) NOT NULL AUTO_INCREMENT,     
