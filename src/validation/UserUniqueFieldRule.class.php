<?php
    lmb_require('limb/validtion/src/rule/lmbSingleFieldRule.class.php');
    ...
    class UserUniqueFieldRule extends lmbSingleFieldRule {
        ...
        public function __construct($field, $current_user) {
        ...
        public function check($value) {
            ...
            if (User::findOne($criteria))
                $this->error('Пользователь со значение поля {Field} уже существует');
